...
Installs use-package (package configuration I'm used to) but then has any use-package calls made to straight.el instead.
#+begin_src emacs-lisp
...
#+end_src
*** Flycheck
Not fully configured yet; but this will get initial syntax checking done.
